...
@Component({
  selector: 'grilla-producto',
  templateUrl: './grilla-producto.component.html',
  styleUrls: ['./grilla-producto.component.scss']
})
export class GrillaProductoComponent implements OnInit {
  ...
  constructor(private storeArmables: Store<{armables: any}>) { 
