...
@Component({
  selector: 'grilla-tallado',
  templateUrl: './grilla-tallado.component.html',
  styleUrls: ['./grilla-tallado.component.scss']
})
export class GrillaTalladoComponent implements OnInit {
  ...
  indiceMax:number = 0;
  tallados$ : Observable<any>;
  constructor(private storeTallados: Store<{tallados: any}>) { 
  ...
  paginadorProducto(indice:number):void{
    ...
    this.listaPaginaProducto = this.productos.patrones.slice(10*indice,10*(indice+1));    
  }
